      ...
      <div className="invoice-print">
        ...
        <div className="invoice-company-row">
          <div className="company-block">
            <h3>From</h3>
            <p><strong>EAST WEST LOGISTICS LLC</strong></p>
            <p>5 Hillcrest Dr<br />Downingtown, PA 19335</p>
            <p>Phone: (409) 248-2002</p>
            <p>Email: info@eastandwestlogistics.com</p>
            <p>Website: https://eastandwestlogistics.com/</p>
          </div>
        ...
        <div className="invoice-footer">
          <span>Generated by EAST WEST LOGISTICS LLC Portal</span>
