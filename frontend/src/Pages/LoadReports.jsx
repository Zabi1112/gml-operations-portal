                ...
                <form className="load-mini-form" onSubmit={saveManualLoad}>
                    ...
                    <div className="form-group">
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                setManualLoad({ ...manualLoad, pickupDate: e.target.value })
                            }
                            required
                        />
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                setManualLoad({ ...manualLoad, dropoffDate: e.target.value })
                            }
                            required
                        />
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                setManualLoad({ ...manualLoad, ratePerMile: e.target.value })
                            }
                        />
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                setManualLoad({ ...manualLoad, grossAmount: e.target.value })
                            }
                        />
                    </div>
                ...
                <form className="load-mini-form" onSubmit={saveReason}>
                    ...
                    <div className="form-group">
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                setReasonForm({ ...reasonForm, reasonDate: e.target.value })
                            }
                            required
                        />
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        <select
                            ...
                            onChange={(e) =>
                                setReasonForm({ ...reasonForm, reasonType: e.target.value })
                            }
                        >
                    ...
                    <div className="form-group">
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                setReasonForm({ ...reasonForm, reasonNote: e.target.value })
                            }
                        />
                    </div>
                            ...
                            <tr key={load.id}>
                                ...
                                <td>
                                    <input
                                        ...
                                        onChange={(e) =>
                                            updateLocalLoad(load.id, "dropoffDate", e.target.value)
                                        }
                                    />
                                </td>
                                ...
                                <td>
                                    <input
                                        ...
                                        onChange={(e) =>
                                            updateLocalLoad(load.id, "ratePerMile", e.target.value)
                                        }
                                    />
                                </td>
                                ...
                                <td>
                                    <input
                                        ...
                                        onChange={(e) =>
                                            updateLocalLoad(load.id, "grossAmount", e.target.value)
                                        }
                                    />
                                </td>
                    ...
                    <tbody>
                        {reasons.map((reason) => (
                            <tr key={reason.id}>
                                ...
                                <td>
                                    <button type="button" onClick={() => deleteReason(reason.id)}>
                                        Delete
                                    </button>
                                </td>
                            </tr>
